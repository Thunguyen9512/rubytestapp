class AuthToken < ApplicationRecord
  ...
  # validates :token, presence: true, length: {maximum: validations.strings.max_length}
  # validates :refresh_token, presence: true, length: {maximum: validations.strings.max_length}
